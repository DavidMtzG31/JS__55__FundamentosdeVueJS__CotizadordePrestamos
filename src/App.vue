...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10" >
    ...
    <div class="my-5 space-y-3 bg-gray-50 p-5">
      ...
      <p class="text-cl text-gray-500 text-center font-bold">Plazo: {{meses}} meses</p>
      <p class="text-cl text-gray-500 text-center font-bold">Abono: {{ formatearDinero(pagoMensual) }}  </p>
